# Contributing
Thanks for taking the time to contribute to the generator-channelape project!
...
- Verify that a bug for this doesn't already exist [here](https://github.com/ChannelApe/generator-channelape/issues).
...
- Verify that a feature request doesn't already exist [here](https://github.com/ChannelApe/generator-channelape/issues).
- Use a clear descriptive title.
